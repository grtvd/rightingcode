...
<jsp:include page="../includes/header.jsp">
	<jsp:param name="title" value="Resume"/>
</jsp:include>
<body>
<style>
.tight-margin
...
<jsp:include page="../includes/navigation.jsp"/>
	...
	<main role="main">
		<article>
			...
			<h1 class="title">Robert S. Davidson</h1>
			...
			<p class="tight-margin">Recruited to lead development of critical account integration software for company's
				...
				managed development process.</p>
			<ul class="tight-margin">
				<li>Successfully integrated a new untested, third-party feature into company's financial software
					solution, finishing on time and within budget. New feature drove sales increases and played key role
					in securing major client worth $3 million per year.</li>
				<li>Integrated new vendors into core product seamlessly, further increasing the value of the product
					while minimizing disruption.</li>
			</ul>
			...
			<ul class="tight-margin">
				<li>Transformed fragmented e-commerce systems into single shopping cart capable of handling multiple
					suppliers and working with all future buying applications.</li>
				<li>Designed and implemented system that integrated the RightWorks procurement system into existing
					buying applications. Completed on-time and within budget. </li>
				<li>Played key role in the integration of e-commerce functionality with the new OM&amp;F system.</li>
			</ul>
			...
			<ul class="tight-margin">
				<li>Developed web-based football, basketball, baseball and hockey games marketed by Affinity Sports and
					Mplayer.com.</li>
				<li>Consultant to MYOB, Inc.</li>
			</ul>
			...
			<ul class="tight-margin">
				<li>Managed all aspects of project which was developed in C++ with high-end InterBase SQL database
					server running under Windows NT. Developed ISAPI web server process for HTML page creation.</li>
			</ul>
			...
			<ul class="tight-margin">
				<li>Established and grew company from start-up to profitable business with annual revenues of $700,000
					before merging with ReviewNet.</li>
				<li>Led development of diverse range of applications and tools including Internet games engines, network
					communications modules, billing applications, HR systems, and development tools. Clients included
					Reuters, MYOB, Inc., Federman &amp; Phelan, LLC and GameLine Sports, LLC.</li>
			</ul>
			...
			<ul class="tight-margin">
				<li>Developed entire back-end logic for fantasy baseball game and golf games for the Prodigy Online
					service. Baseball game was later ported to Internet.</li>
				<li>Worked on WealthBuilder by Money Magazine, a financial application for tracking personal assets.
					Provided research database updates via dial-up serial connection.</li>
			</ul>
			...
			<p>Drexel University, B.S. in Computer Science, 1989</p>
